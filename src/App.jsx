...
function Nav() {
  ...
  const ids   = ["appartamento", "posizione", "esperienze", "testimonianze", "blog"];
  return (
    <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "3rem", width: "100%", paddingTop: "5rem", paddingBottom: "3rem", flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 320px", minWidth: 0 }}>
            ...
            <div style={{ opacity: loaded?1:0, transform: loaded?"translateY(0)":"translateY(24px)", transition: "all 0.85s ease 0.6s", display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              ...
              <a href="#appartamento" style={{ border: "1.5px solid rgba(160,120,42,0.35)", color: C.textMid, padding: "0.95rem 1.75rem", fontSize: "0.8rem", letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none", fontFamily: "'Space Grotesk',sans-serif", transition: "all 0.25s", whiteSpace: "nowrap" }}
    ...
    <section id="posizione" style={{ background: C.bg, padding: "7rem 2rem" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Reveal>
          <div style={{ marginBottom: "3.5rem" }}>
            ...
            <h2 style={{ fontFamily: "'Lora','Georgia',serif", fontSize: "clamp(1.9rem,4vw,3.2rem)", color: C.text, fontWeight: 700, lineHeight: 1.1, maxWidth: 600, letterSpacing: "-0.02em" }}>
              Nel cuore di Cesenatico,<br /><span style={{ color: C.gold, fontStyle: "italic" }}>a due passi dal mare.</span>
            </h2>
          </div>
        </Reveal>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }} className="loc-grid">
          <Reveal>
            <div>
              <h3 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "0.72rem", letterSpacing: "0.2em", textTransform: "uppercase", color: C.textSoft, marginBottom: "1.1rem" }}>DISTANZE PRINCIPALI</h3>
          ...
          <div>
            <Reveal delay={100}>
              <h3 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "0.72rem", letterSpacing: "0.2em", textTransform: "uppercase", color: C.textSoft, marginBottom: "1.1rem" }}>COSA FARE NEI DINTORNI</h3>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.6px", background: C.border }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Reveal>
          <div style={{ textAlign: "center", marginBottom: "4.5rem" }}>
            <div style={{ fontSize: "0.67rem", letterSpacing: "0.28em", color: C.gold, textTransform: "uppercase", fontFamily: "'Space Grotesk',sans-serif", marginBottom: "0.85rem" }}>Semplice dall'inizio alla fine</div>
            <h2 style={{ fontFamily: "'Lora','Georgia',serif", fontSize: "clamp(1.9rem,4vw,3.2rem)", color: C.text, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
              Il tuo soggiorno sul mare,<br /><span style={{ color: C.gold, fontStyle: "italic" }}>senza complicazioni.</span>
            </h2>
          </div>
        </Reveal>
  ...
  return (
    <section id="testimonianze" style={{ background: C.bg, padding: "7rem 2rem" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Reveal>
          <div style={{ marginBottom: "3.5rem" }}>
            <div style={{ fontSize: "0.67rem", letterSpacing: "0.28em", color: C.gold, textTransform: "uppercase", fontFamily: "'Space Grotesk',sans-serif", marginBottom: "0.85rem" }}>Esperienze Reali</div>
            <h2 style={{ fontFamily: "'Lora','Georgia',serif", fontSize: "clamp(1.9rem,4vw,3.2rem)", color: C.text, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
        ...
        <Reveal delay={160}>
          <div style={{ marginTop: "2.25rem", display: "flex", alignItems: "center", gap: "1.25rem", flexWrap: "wrap" }}>
            <div style={{ color: C.textSoft, fontSize: "0.73rem", fontFamily: "'Space Grotesk',sans-serif", letterSpacing: "0.12em", textTransform: "uppercase" }}>Su Airbnb</div>
            {["★ 4.96 / 5", "27 Recensioni", "Superhost"].map(b => (
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Reveal>
          <div style={{ marginBottom: "3.5rem" }}>
            ...
            <h2 style={{ fontFamily: "'Lora','Georgia',serif", fontSize: "clamp(1.9rem,4vw,3.2rem)", color: C.text, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
              Scopri Cesenatico<br /><span style={{ color: C.gold, fontStyle: "italic" }}>con i nostri occhi.</span>
            </h2>
          </div>
        </Reveal>
        {aperto === null && (
              ...
              <Reveal key={post.id} delay={i * 80}>
                <div onClick={() => setAperto(post.id)}
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
                    ...
                    <span style={{ fontSize: "0.68rem", color: C.textSoft, fontFamily: "'Space Grotesk',sans-serif" }}>{new Date(post.data).toLocaleDateString("it-IT", { day: "numeric", month: "long", year: "numeric" })}</span>
                  </div>
            ...
            <Reveal>
              <div style={{ maxWidth: 760, margin: "0 auto" }}>
                ...
                <div style={{ marginTop: "3rem", padding: "2rem", background: C.bg3, borderLeft: `3px solid ${C.gold}` }}>
                  <p style={{ fontFamily: "'Lora','Georgia',serif", fontSize: "1.1rem", color: C.text, marginBottom: "1rem", fontStyle: "italic" }}>Vuoi soggiornare a Cesenatico a due passi dal mare?</p>
                  <a href={STRUTTURA.airbnb} target="_blank" rel="noopener noreferrer"
  ...
  return (
    <section style={{ background: C.bg, padding: "9rem 2rem", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
        <Reveal>
          <div style={{ fontSize: "0.67rem", letterSpacing: "0.28em", color: C.gold, textTransform: "uppercase", fontFamily: "'Space Grotesk',sans-serif", marginBottom: "1.3rem" }}>Pronto a prenotare?</div>
          <h2 style={{ fontFamily: "'Lora','Georgia',serif", fontSize: "clamp(2rem,5vw,3.8rem)", color: C.text, fontWeight: 700, lineHeight: 1.05, marginBottom: "1.3rem", letterSpacing: "-0.025em" }}>
            La tua estate sul mare<br /><span style={{ color: C.gold, fontStyle: "italic" }}>inizia qui.</span>
          </h2>
          <p style={{ fontSize: "1rem", color: C.textMid, lineHeight: 1.85, fontFamily: "'Space Grotesk',sans-serif", marginBottom: "2.5rem" }}>
            Le date estive si esauriscono rapidamente. Controlla ora la disponibilita su Airbnb e assicurati il tuo posto a Cesenatico.
          </p>
          <a href={STRUTTURA.airbnb} target="_blank" rel="noopener noreferrer"
    ...
    <footer style={{ background: C.bg3, borderTop: `1px solid ${C.border}`, padding: "4rem 2rem 2rem" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "3rem", marginBottom: "3rem" }} className="footer-grid">
          <div>
            ...
            <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "0.76rem", color: C.textSoft, lineHeight: 1.7 }}>
              Casa vacanze a Cesenatico, a 400 mt dal mare.<br />Vicino a Cesena, Rimini, San Marino.
            </div>
          </div>
          <div>
            <div style={{ fontSize: "0.67rem", letterSpacing: "0.18em", textTransform: "uppercase", color: C.textSoft, fontFamily: "'Space Grotesk',sans-serif", marginBottom: "0.85rem" }}>Naviga</div>
            {[["Appartamento","appartamento"],["Posizione","posizione"],["Esperienze","esperienze"],["Testimonianze","testimonianze"],["Blog","blog"]].map(([l,id]) => (
          ...
          <div>
            <div style={{ fontSize: "0.67rem", letterSpacing: "0.18em", textTransform: "uppercase", color: C.textSoft, fontFamily: "'Space Grotesk',sans-serif", marginBottom: "0.85rem" }}>Prenota</div>
            <a href={STRUTTURA.airbnb} target="_blank" rel="noopener noreferrer"
            ...
            <div style={{ marginTop: "1.25rem", fontFamily: "'Space Grotesk',sans-serif", fontSize: "0.74rem", color: C.textSoft, lineHeight: 1.7 }}>Disponibile su Airbnb.<br />Fino a 6 ospiti.</div>
          </div>
        </div>
        <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "0.75rem" }}>
          <div style={{ fontSize: "0.72rem", color: C.textSoft, fontFamily: "'Space Grotesk',sans-serif" }}>© {new Date().getFullYear()} La Perla del Mare · Cesenatico · Tutti i diritti riservati</div>
          <div style={{ fontSize: "0.72rem", color: C.textSoft, fontFamily: "'Space Grotesk',sans-serif", letterSpacing: "0.1em" }}>CON ♥ IN ROMAGNA</div>
        </div>
      </div>
